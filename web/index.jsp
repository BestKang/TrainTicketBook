...
<div class="right">
	<div class="revise">
	    <table class="table table-condensed table-bordered" id="tableSort">
                ...
                <tr>
                    ...
                    <th class="th2">出发站</th>
                    <th class="th3">到达站</th>
                    <th class="th4" onclick="$.sortTable.sort('tableSort',0)" style="cursor: pointer;">票价▽</th>
                    <th class="th5" onclick="$.sortTable.sort('tableSort',0)" style="cursor: pointer;">出发时间▽</th>
                    <th class="th6" onclick="$.sortTable.sort('tableSort',0)" style="cursor: pointer;">到达时间▽</th>
                    <th class="th7" onclick="$.sortTable.sort('tableSort',0)" style="cursor: pointer;">距离▽</th>
                ...
                <%--<tr>--%>
                    <%
                        ...
                        while (true){
                            ...
                            if (jsonObject!=null){ %>
                                <tr>
                                <td class="td1"><%=jsonObject.get("id") %></td>
                                <td class="td2"><%=jsonObject.get("from")%></td>
                                <td class="td3"><%=jsonObject.get("to") %></td>
                                <td class="td4"><%=jsonObject.get("price") %></td>
                                <td class="td5"><%=(jsonObject.get("arTime"))%></td>
                                <td class="td6"><%=jsonObject.get("deTime") %></td>
                                <td class="td7"><%=jsonObject.get("distance") %></td>
                                </tr>
                                <%
                                i++;
                            }
